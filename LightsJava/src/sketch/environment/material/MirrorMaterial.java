...
public class MirrorMaterial extends Material {
  ...
  public HitColor getColor(Intersection intersection) {
    ...
    Intersection throughIntersect = environment
        .intersect(new Ray(Vector.sub(intersection.position, intersection.ray.direction),
            Vector.reflect(intersection.ray.direction, intersection.normal), intersection.ray.depth + 1));
